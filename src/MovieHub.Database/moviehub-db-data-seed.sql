...
-- ======================== INSERT Movie =========================
INSERT INTO Movies (Title, ReleaseDate, Genre, Runtime, Synopsis, Director, Rating, PrincessTheatreMovieId) VALUES 
  (
...
-- ======================== INSERT MovieCinema =========================
INSERT INTO Showings (MovieId, CinemaId, Showtime, TicketPrice) VALUES
(
  (SELECT Id FROM Movies WHERE Title = "Star Wars: The Phantom Menace (Episode I)"),
  (SELECT Id FROM Cinemas WHERE Name = "Cinemarvel"),
  "2024-12-31",
  24.50
),
(
  (SELECT Id FROM Movies WHERE Title = "Star Wars: The Phantom Menace (Episode I)"),
  (SELECT Id FROM Cinemas WHERE Name = "Moviesmania"),
  "2024-12-31",
  22.75
),
(
  (SELECT Id FROM Movies WHERE Title = "Star Wars: The Phantom Menace (Episode I)"),
  (SELECT Id FROM Cinemas WHERE Name = "BigScreen Bliss"),
  "2024-12-31",
  20.00
),
(
  (SELECT Id FROM Movies WHERE Title = "Star Wars: The Phantom Menace (Episode I)"),
  (SELECT Id FROM Cinemas WHERE Name = "CineNova"),
  "2024-12-31",
  21.50
),
(
  (SELECT Id FROM Movies WHERE Title = "Star Wars: The Phantom Menace (Episode I)"),
  (SELECT Id FROM Cinemas WHERE Name = "Cinema Royale"),
  "2024-12-31",
  22.25
),
(
  (SELECT Id FROM Movies WHERE Title = "Star Wars: The Phantom Menace (Episode I)"),
  (SELECT Id FROM Cinemas WHERE Name = "Flicker Factory"),
  "2024-12-31",
  23.75
),
(
  (SELECT Id FROM Movies WHERE Title = "Star Wars: The Phantom Menace (Episode I)"),
  (SELECT Id FROM Cinemas WHERE Name = "CineSpectra"),
  "2024-12-31",
  22.75
),
(
  (SELECT Id FROM Movies WHERE Title = "Star Wars: Attack of the Clones (Episode II)"),
  (SELECT Id FROM Cinemas WHERE Name = "Cinemarvel"),
  "2024-12-31",
  26.25
),
...
(
  (SELECT Id FROM Movies WHERE Title = "Star Wars: Revenge of the Sith (Episode III)"),
  (SELECT Id FROM Cinemas WHERE Name = "Cinemarvel"),
  "2024-12-31",
  21.25
),
...
(
  (SELECT Id FROM Movies WHERE Title = "Star Wars: A New Hope (Episode IV)"),
  (SELECT Id FROM Cinemas WHERE Name = "Cinemarvel"),
  "2024-12-31",
  28.00
),
...
(
  (SELECT Id FROM Movies WHERE Title = "Star Wars: The Empire Strikes Back (Episode V)"),
  (SELECT Id FROM Cinemas WHERE Name = "Cinemarvel"),
  "2024-12-31",
  28.25
),
...
(
  (SELECT Id FROM Movies WHERE Title = "Star Wars: Return of the Jedi (Episode VI)"),
  (SELECT Id FROM Cinemas WHERE Name = "Cinemarvel"),
  "2024-12-31",
  29.50
),
...
(
  (SELECT Id FROM Movies WHERE Title = "Star Wars: The Force Awakens (Episode VII)"),
  (SELECT Id FROM Cinemas WHERE Name = "Cinemarvel"),
  "2024-12-31",
  24.50
),
...
(
  (SELECT Id FROM Movies WHERE Title = "Star Wars: The Last Jedi (Episode VIII)"),
  (SELECT Id FROM Cinemas WHERE Name = "Cinemarvel"),
  "2024-12-31",
  27.50
),
...
(
  (SELECT Id FROM Movies WHERE Title = "Star Wars: The Rise of Skywalker (Episode IX)"),
  (SELECT Id FROM Cinemas WHERE Name = "Cinemarvel"),
  "2024-12-31",
  25.75
),
